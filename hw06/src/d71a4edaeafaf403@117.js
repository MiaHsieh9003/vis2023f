...
Plot.plot({
  ...
  color: {
    ...
    range: ['#EC82C5', '#33A6B8'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
  ...
  series.forEach((serie) => {
      ...
      bars.enter().append("rect")
          ...
          .on("mouseover", function(d) {
              d3.select(this).attr("fill", "#A5DEE4");
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["public.csv", {url: new URL("./files/0d0d52bc881b9a95fa2349e6b1aeb0d4395e1010ed387a1f715ce1e46c65b1e7d1a31c7e054e1ae51ed050c444fbb196bdfe76b62fbde4f21ad54e280270bb49.csv", import.meta.url), mimeType: "text/csv", toString}],
