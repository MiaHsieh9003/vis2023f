...
htl.html` <hr><h2>Strong baseline:</h2><br>
  <h4>按以下按鈕就會得到所有data in console，兩者互動: button與data</h4>`
)}
...
function* _progress(replay,DOM,data)
{
  replay;
  const width = 360;
  const height = 20;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("progress")).define("progress", ["replay","DOM","data"], _progress);
  return main;
}
